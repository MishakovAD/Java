  ...
  extends HttpServlet
{
    ...
    throws ServletException, IOException
  {
    ...
    if (str2.length() == 0)
    {
      ...
      else
      {
        ...
        localPrintWriter.println("<br><br><br>&copy; <a href=\"mailto:info@servletsuite.com\">Coldbeans</a> ver. 2.2");
        localPrintWriter.println("</html>");
  ...
  private void dumpFile(String paramString, OutputStream paramOutputStream, long paramLong)
  {
    ...
    try
    {
      BufferedInputStream localBufferedInputStream = new BufferedInputStream(new FileInputStream(lookupFile(str)));
      int i;
